...
export function PrismaAdapter(
  ...
  return {
    // esse createUser não cria um usuário, mas busca o usuário (userID) já criado na página de pré cadastro, que está salvo nos cookies
    async createUser(user) {
      // parse cookies da nookies é usado para buscar os cookies
      ...
      // apagando os cookies após login pois não será mais utilizado
